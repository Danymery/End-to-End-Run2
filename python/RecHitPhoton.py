...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring(
        #'root://eospublic.cern.ch//eos/opendata/cms/mc/RunIIFall15MiniAODv2/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/MINIAODSIM/PU25nsData2015v1_76X_mcRun2_asymptotic_v12-v1/00000/0005EA25-8CB8-E511-A910-00266CF85DA0.root'   
       	#'root://eospublic.cern.ch//eos/opendata/cms/mc/RunIIFall15MiniAODv2/GluGluHToEEG_M125_MLL-0To50_Dalitz_13TeV_madgraph_pythia8/MINIAODSIM/PU25nsData2015v1_76X_mcRun2_asymptotic_v12_ext1-v2/10000/38DB1CA9-64C1-E511-BA90-001EC9ADE703.root'
        'root://eospublic.cern.ch//eos/opendata/cms/MonteCarlo2012/Summer12_DR53X/GluGluHToGG_M-125_8TeV-pythia6/AODSIM/PU_RD1_START53_V7N-v2/00000/02590948-234A-E411-87AF-7845C4FC3A61.root'
	)
)
if isData:
...
process.myrechit = cms.EDAnalyzer('PhotonRecHit3', gedPhotonCollection = cms.InputTag("photons"), EBRecHitCollection = cms.InputTag("EBRecHitCollection"),reducedEERecHitCollection = cms.InputTag("reducedEcalRecHitsEE"))

process.myjuego = cms.EDAnalyzer('RecHitAnalyzer',gedPhotonCollection = cms.InputTag("slimmedPhotons"))

process.myjuego2 = cms.EDAnalyzer('RecHit2', fotones = cms.InputTag("photons"), CollectionEBRecHit=cms.InputTag("EBRecHitCollection"),CollectionEERecHit=cms.InputTag("EERecHitCollection"),
		   		  CollectionHBHERecHit=cms.InputTag("reducedHcalRecHits:hbhereco" ))
...
#----- RUN THE JOB! -----#
process.TFileService = cms.Service("TFileService", fileName=cms.string("RecHit4.root"))
...
if isData:
	...
	process.p = cms.Path(process.myjuego2)
